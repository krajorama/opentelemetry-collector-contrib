...
| `receiver.prometheusreceiver.RemoveReportExtraScrapeMetricsConfig` | stable | When enabled, the 'report_extra_scrape_metrics' configuration option is ignored, and extra scrape metrics are controlled solely by the EnableReportExtraScrapeMetrics feature gate. The intention is to have extra scrape metrics enabled all the time in the future. | v0.143.0 | v0.148.0 | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/44181) |
